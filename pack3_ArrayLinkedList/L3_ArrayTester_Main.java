...
public class L3_ArrayTester_Main {
    ...
    static public void myArray_demo4() {
        MyArray_651463 demo = new MyArray_651463(5);
        demo.delete(0);
        demo.add(3);
        demo.add(7);
        demo.add(5);
    ...
    static public void task2() {
        for (int N = 200_000; N <= 10 * 200_000; N += 200_000) {
            ...
            MyArray_651463 mArray = new MyArray_651463(N);
            for (int n = 1; n < N; n++)
        ...
        for (int N = 200_000; N <= 10 * 200_000; N += 200_000) {
            long start = System.currentTimeMillis();
            MyArray_651463 mArray = new MyArray_651463();
            for (int n = 1; n < N; n++)
                mArray.add((int) (Math.random() * 1000));
            long time = (System.currentTimeMillis() - start);
            System.out.println(N + "\t\t" + time);
