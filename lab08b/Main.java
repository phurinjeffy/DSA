...
public class Main {
    ...
    private static void testRuntime() {
        ...
        System.out.println("32: takes " + Arrays.toString(size32Time));
        System.out.println("2048: takes " + Arrays.toString(size2048Time));
        System.out.println("Built-in: takes " + Arrays.toString(sizeSortTime));
    }
